...
class CssTricksSpider(scrapy.Spider):
    name = 'css_tricks'
    allowed_domains = ['css-tricks.com']
    start_urls = ['https://css-tricks.com/feed/']
    ...
    def parse_article(self, response):
        ...
        author = response.css('.entry-author-name::text, .author::text').get() or ''
        ...
        news['cover_image'] = response.css('figure img::attr(src), .entry-content img::attr(src)').get() or ''
        yield news
