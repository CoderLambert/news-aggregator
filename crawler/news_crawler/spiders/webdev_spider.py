...
class WebDevSpider(scrapy.Spider):
    """web.dev — Google's web platform news. Uses <updated> instead of <pubDate>."""
    name = 'webdev'
    allowed_domains = ['web.dev']
    start_urls = ['https://web.dev/blog/feed.xml']
    ...
    def parse(self, response):
        ...
        for item in response.css('item'):
            ...
            # web.dev uses <updated> instead of <pubDate>
