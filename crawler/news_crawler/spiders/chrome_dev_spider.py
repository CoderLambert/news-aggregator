...
class ChromeDevSpider(scrapy.Spider):
    """Chrome Developers blog. Uses <updated> instead of <pubDate>."""
    name = 'chrome_dev'
    allowed_domains = ['developer.chrome.com']
    start_urls = ['https://developer.chrome.com/static/blog/feed.xml']
    ...
    def parse(self, response):
        ...
        for item in response.css('item'):
            ...
            # Chrome Dev uses <updated> instead of <pubDate>
            pub_date = item.css('pubDate::text').get('') or item.css('updated::text').get('')
            ...
            news['source_name'] = 'Chrome Developers'
