...
class MozillaHacksSpider(scrapy.Spider):
    name = 'mozilla_hacks'
    allowed_domains = ['hacks.mozilla.org']
    start_urls = ['https://hacks.mozilla.org/feed/']
    ...
    def parse(self, response):
        ...
        for item in response.css('item'):
            ...
            news['source_name'] = 'Mozilla Hacks'
    ...
    def parse_article(self, response):
        ...
        author = response.css('.entry-author::text, .author::text').get() or ''
